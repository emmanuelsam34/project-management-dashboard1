  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disabled:to-neutral-100 disabled:text-neutral-100 disabled:text-neutral-300 border-neutral-200 shadow-sm",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-amber-800 text-destructive-foreground hover:from-amber-900 hover:to-amber-900",
        outline:
          "border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground",
        secondary:
          "bg-white shadow-sm text-black hover:bg-neutral-100",
        ...
        red: "bg-red-600 text-white border-red hover:bg-black"
      },
      size: {
